...
class Generate(BaseUI):
    group = 'llm_infer'
    locale_dict = {'max_new_tokens': {'label': {'zh': 'Max new tokens', 'en': 'Max new tokens'}}, 'temperature': {'label': {'zh': 'Temperature', 'en': 'Temperature'}}, 'top_k': {'label': {'zh': 'Top-k', 'en': 'Top-k'}}, 'top_p': {'label': {'zh': 'Top-p', 'en': 'Top-p'}}, 'repetition_penalty': {'label': {'zh': 'Repetition Penalty', 'en': 'Repetition Penalty'}}, 'system': {'label': {'zh': 'System', 'en': 'System'}, 'info': {'zh': 'System can be modified after the model weights loaded', 'en': 'System can be modified after the model weights loaded'}}}
