...
class LoRA(BaseUI):
    group = 'llm_train'
    locale_dict = {'lora_tab': {'label': {'zh': 'LoRA settings', 'en': 'LoRA settings'}}, 'lora_rank': {'label': {'zh': 'The LoRA rank', 'en': 'The LoRA rank'}}, 'lora_alpha': {'label': {'zh': 'The LoRA alpha', 'en': 'The LoRA alpha'}}, 'lora_dropout': {'label': {'zh': 'The LoRA dropout', 'en': 'The LoRA dropout'}}, 'use_rslora': {'label': {'zh': 'Use rsLoRA', 'en': 'Use rsLoRA'}}, 'use_dora': {'label': {'zh': 'Use DoRA', 'en': 'Use DoRA'}}, 'lora_dtype': {'label': {'zh': 'The dtype of LoRA', 'en': 'The dtype of LoRA'}}}
