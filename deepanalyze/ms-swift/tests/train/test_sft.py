...
def test_llm_ddp():
    ...
    result = sft_main(
        TrainArguments(
            ...
            dataset=[
                "AI-ModelScope/alpaca-gpt4-data-zh#100",
...
def test_mllm_mp():
    ...
    infer_main(
        InferArguments(
            ckpt_dir=last_model_checkpoint, load_data_args=True, merge_lora=True
        )
    )
...
def test_qwen_vl():
    ...
    sft_main(
        TrainArguments(
            ...
            dataset=[
                "AI-ModelScope/LaTeX_OCR#40",
                "modelscope/coco_2014_caption:validation#40",
            ],
            split_dataset_ratio=0.01,
            **kwargs
        )
...
def test_resume_only_model():
    ...
    result = sft_main(
        TrainArguments(
            model="Qwen/Qwen2-0.5B",
            dataset=[
                "AI-ModelScope/alpaca-gpt4-data-zh#10",
                "AI-ModelScope/alpaca-gpt4-data-en#10",
            ],
            split_dataset_ratio=0.01,
            max_steps=20,
...
def test_epoch():
    ...
    result = sft_main(
        TrainArguments(
            model="Qwen/Qwen2-7B-Instruct",
            dataset=[
                "AI-ModelScope/alpaca-gpt4-data-zh#50",
